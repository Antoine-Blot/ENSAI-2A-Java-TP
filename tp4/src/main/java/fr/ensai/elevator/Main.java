...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        final int nbFloors = Config.getInt("hotel.floors.count");

        final int elevatorCapacity = Config.getInt("hotel.elevators.capacity");
        final int nbElevators = Config.getInt("hotel.elevators.count");
